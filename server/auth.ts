          ...
          try {
            ...
            if (!user) {
              ...
              if (user) {
                ...
                // This would require updating the user record - we'll keep them separate for now
                return done(null, false, { message: "Email already registered with password. Please sign in with email/password." });
              } else {
